...
## Dataset
`dataFiles/` contains placeholder TSV files (no tokens, Twitter/X policy). Obtain the Hinglish POS corpus from [Singh et al., 2018](https://aclanthology.org/W18-3503/) and place in `dataFiles/`. Training split: first 30,262 tokens; test: remaining 3,327 tokens.
