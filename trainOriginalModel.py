...
TRAIN_FILE = "dataFiles/finalTrainData.tsv"
...
print(f"Loaded {len(orig_sents)} original sentences and 0 synthetic sentences.")

# Combine sentences and tags
sentences = orig_sents
pos_tags = orig_tags
print(f"Loaded {len(sentences)} total sentences (orig {len(orig_sents)}, synth 0)")
